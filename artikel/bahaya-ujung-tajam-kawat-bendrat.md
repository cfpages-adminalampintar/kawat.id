---
article_id: KWT-06-04
title: "Bahaya Ujung Tajam Bendrat dan Pengendalian di Area Kerja"
slug: "bahaya-ujung-tajam-kawat-bendrat"
description: "Define handling, folding/capping, access control, waste collection, PPE, first-response, and stop-work triggers"
status: outline
publication_date: "2025-09-21"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KWT-06
primary_intent: "Prevent cuts and impalement"
reader_community: "Kawat.id"
reader_address: "Teman Kawat.id"
final_route: "/artikel/bahaya-ujung-tajam-kawat-bendrat.html"
...
# Bahaya Ujung Tajam Bendrat dan Pengendalian di Area Kerja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Bahaya Ujung Tajam Bendrat dan Pengendalian di Area Kerja”
- **Reader and situation:** Site supervisor planning housekeeping and PPE
- **Reader outcome:** Define handling, folding/capping, access control, waste collection, PPE, first-response, and stop-work triggers
- **Primary intent:** Prevent cuts and impalement
...
- **Scope boundary:** Excludes medical treatment and general site JSA owned by KWT-16-02
- **Final public route:** `/artikel/bahaya-ujung-tajam-kawat-bendrat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Bahaya Ujung Tajam Bendrat dan Pengendalian di Area Kerja**.
...
- **Exact Markdown to insert:** `![Ilustrasi Kawat Bendrat 1](/wp-content/uploads/2023/02/Kawat-Bendrat-1.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Kawat Bendrat 1` as relevant content media; no pixels were inspected.
...
- `/kawat-bendrat-yalimo-papua` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kawat-bendrat-yahukimo-papua` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kawat-bendrat-wonosobo-jawa-tengah` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kawat-bendrat-wonogiri-jawa-tengah` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kawat-bendrat-way-kanan-lampung` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kawat-bendrat-waropen-papua` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `KWT-06-02` → `/artikel/pola-ikatan-kawat-bendrat.html` — Pola Ikatan Bendrat dan Kapan Mengikuti Metode Proyek
- `KWT-06-03` → `/artikel/alat-ikat-kawat-bendrat.html` — Tang, Hook, dan Alat Ikat Bendrat: Produktivitas serta Ergonomi
- `KWT-06-05` → `/artikel/estimasi-kebutuhan-kawat-bendrat.html` — Mengestimasi Kebutuhan Bendrat tanpa Mengarang Angka Baku
- `KWT-06-06` → `/artikel/penyimpanan-kawat-bendrat.html` — Penyimpanan Bendrat: Karat, Kusut, Kontaminasi, dan Sisa Coil
...
- **Tie back to this article:** Keep the explanation specific to “Bahaya Ujung Tajam Bendrat dan Pengendalian di Area Kerja”.
